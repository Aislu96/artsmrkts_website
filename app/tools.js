    ...
    return (
        <section className="py-32 max-w-[1280px] mx-auto flex flex-col gap-20">
            <div className="flex flex-row items-center justify-between">
                <h2 className="font-medium text-[44px] leading-[52.28px] max-w-[621px]">Trade Smarter with Our Trading Tools</h2>
                <p className="text-[16px] leading-[19.2px] max-w-[476px]">
                    Are you ready to reach a new level in the world of investments and earn serious money in the financial markets?
                    Then you definitely need to take a closer look at our tariff offers!
                </p>
            </div>
            <div className="flex flex-col gap-4">
                ...
                <p className="border-l-[3px] border-l-solid border-l-customOrangeSeven py-2.5 pl-6 pr-2.5 font-medium text-[20px] leading-[24px] transition-opacity duration-500 ease-in-out">
